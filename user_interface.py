import sys
size_1=int(sys.argv[1])
size_2=int(sys.argv[2])
...
class pcapXrayGui:
    def __init__(self, base):
        ...
        self.filename_field = ttk.Entry(InitFrame, width=36, textvariable=self.pcap_file, style="BW.TEntry").grid(column=1, row=0, sticky="W, E")
        self.progressbar = ttk.Progressbar(InitFrame, orient="horizontal", length=250,value=0, maximum=200,  mode="indeterminate")
        ...
        ttk.Label(FirstFrame, text="Output directory path: ",style="BW.TLabel").grid(column=0, row=0, sticky="E")
        ...
        self.ibutton = ttk.Button(SecondFrame, text="Table!", command=self.gimmick)
        ...
        self.ibutton = ttk.Button(SecondFrame, text="Chart!", command=self.chart)
        self.ibutton.grid(row=10, column=12, padx=10, sticky="E")
        #self.ibutton = ttk.Button(SecondFrame, text="Intensity!", command=self.chart)
        #self.ibutton.grid(row=10, column=13, padx=10, sticky="E")
    ...
    def gimmick(self):
        packets=rdpcap(self.pcap_file.get())
        srcIP=[]
    ...
    def load_image(self):
        self.canvas = Canvas(self.ThirdFrame, width=size_1,height=size_2, bd=0, bg="navy", xscrollcommand=self.xscrollbar.set, yscrollcommand=self.yscrollbar.set)
